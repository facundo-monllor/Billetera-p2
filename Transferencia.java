...
public class Transferencia extends Operacion{
    ...
    public Transferencia(Double monto, String remitenteCVU, String destinatarioCVU, String destinatarioDNI, Boolean estado) {
        ...
        if (remitenteCVU == null || remitenteCVU.isEmpty()) throw new RuntimeException("El remitente es obligatorio");
        if (destinatarioCVU == null || destinatarioCVU.isEmpty()) throw new RuntimeException("El destinatario es obligatorio");
        if (destinatarioDNI == null || destinatarioDNI.isEmpty()) throw new RuntimeException("El destinatario es obligatorio");
